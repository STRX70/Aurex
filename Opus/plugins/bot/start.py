...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        out = private_panel(_)
        await message.reply(
            text='<blockquote><b><u>ᴅɪᴠᴇ ɪɴᴛᴏ ᴀ ᴍᴜꜱɪᴄᴀʟ ᴜɴɪᴠᴇʀꜱᴇ 🎶</u></b></blockquote>\n<blockquote><b><u>ᴇʟᴇᴠᴀᴛᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴠᴏɪᴄᴇ & ᴠɪᴅᴇᴏ ᴄʜᴀᴛꜱ ᴡɪᴛʜ ʜɪɢʜ-Qᴜᴀʟɪᴛʏ ᴍᴜꜱɪᴄ.</u>ꜱᴛʀᴇᴀᴍ ᴀɴʏᴛɪᴍᴇ, ᴀɴʏᴡʜᴇʀᴇ — ꜱᴍᴏᴏᴛʜ ᴀɴᴅ ᴜɴɪɴᴛᴇʀʀᴜᴘᴛᴇᴅ.\n💡 ᴛʏᴘᴇ /help ᴛᴏ ꜱᴇᴇ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅꜱ</b></blockquote>\n<blockquote>''<b>Ɵᴘᴜs ᴠ2</b><a href="https://files.catbox.moe/73bq1s.mp4">.</a>1 [B2.01.0]</blockquote>',
